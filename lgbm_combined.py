...
def get_model(X_train, y_train):
    ...
    # This will give you the count of 1s and 0s
    # count_of_1 = counts.get(1, 0)  # Gets the count of 1s, default to 0 if not present
    # count_of_0 = counts.get(0, 0)  # Gets the count of 0s, default to 0 if not present

    # scale_pos_weight_value = count_of_0 / count_of_1
    lgb_params = {
    ...
    'max_depth': -1, # +1 -1~8
    'min_data_in_leaf': 5, # 20 ~ 900
    'is_unbalance': True, # 'scale_pos_weight'
    # 'scale_pos_weight': scale_pos_weight_value,
    'max_bin': 255, # +100 or + 200 255 ~ 1024 
    'verbose': -1, 
