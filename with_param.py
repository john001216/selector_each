...
def simulated_annealing(X_train,
    ...
    lgbm_models = lgbm_for_param.get_model(X_train, y_train)
    ...
    lgbm_models = lgbm_for_param.get_model(X_train_curr, y_train)
    ...
    for i in range(maxiters):
        ...
        lgbm_models = lgbm_for_param.get_model(X_train_new, y_train)
